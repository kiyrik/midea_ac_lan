...
MIDEA_DEVICES: dict[int, dict[str, dict[str, Any] | str]] = {
    ...
    0xC3: {
        ...
        "entities": {
            ...
            C3Attributes.pressure_high: {"type": Platform.SENSOR, "translation_key": "pressure_high", "name": "High Pressure", "device_class": SensorDeviceClass.PRESSURE, "unit": UnitOfPressure.KPA, "state_class": SensorStateClass.MEASUREMENT},            C3Attributes.pressure_low: {"type": Platform.SENSOR, "translation_key": "pressure_low", "name": "Low Pressure", "device_class": SensorDeviceClass.PRESSURE, "unit": UnitOfPressure.KPA, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.temp_t4_outdoor_air: {"type": Platform.SENSOR, "translation_key": "temp_t4", "name": "T4 - Outdoor Air Temperature", "device_class": SensorDeviceClass.TEMPERATURE, "unit": UnitOfTemperature.CELSIUS, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.temp_t4_average: {"type": Platform.SENSOR, "translation_key": "temp_t4_average", "name": "T4 Average Temperature", "device_class": SensorDeviceClass.TEMPERATURE, "unit": UnitOfTemperature.CELSIUS, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.temp_t5_tank: {"type": Platform.SENSOR, "translation_key": "temp_t5", "name": "T5 - Tank Temperature", "device_class": SensorDeviceClass.TEMPERATURE, "unit": UnitOfTemperature.CELSIUS, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.temp_t1_leaving_water: {"type": Platform.SENSOR, "translation_key": "temp_t1", "name": "T1 - Leaving Water Temperature", "device_class": SensorDeviceClass.TEMPERATURE, "unit": UnitOfTemperature.CELSIUS, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.temp_t2_plate_f_out: {"type": Platform.SENSOR, "translation_key": "temp_t2", "name": "T2 - Plate F-OUT Temperature", "device_class": SensorDeviceClass.TEMPERATURE, "unit": UnitOfTemperature.CELSIUS, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.temp_t2b_plate_f_in: {"type": Platform.SENSOR, "translation_key": "temp_t2b", "name": "T2B - Plate F-IN Temperature", "device_class": SensorDeviceClass.TEMPERATURE, "unit": UnitOfTemperature.CELSIUS, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.temp_t3_outdoor_exchanger: {"type": Platform.SENSOR, "translation_key": "temp_t3", "name": "T3 - Outdoor Exchanger Temperature", "device_class": SensorDeviceClass.TEMPERATURE, "unit": UnitOfTemperature.CELSIUS, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.temp_th_comp_suction: {"type": Platform.SENSOR, "translation_key": "temp_th", "name": "Th - Compressor Suction Temperature", "device_class": SensorDeviceClass.TEMPERATURE, "unit": UnitOfTemperature.CELSIUS, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.temp_tp_comp_discharge: {"type": Platform.SENSOR, "translation_key": "temp_tp", "name": "Tp - Compressor Discharge Temperature", "device_class": SensorDeviceClass.TEMPERATURE, "unit": UnitOfTemperature.CELSIUS, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.fg_capacity_need: {"type": Platform.SENSOR, "translation_key": "fg_capacity_need", "name": "Capacity Demand", "icon": "mdi:gauge", "state_class": SensorStateClass.MEASUREMENT},
            ...
            C3Attributes.total_renew_power0: {"type": Platform.SENSOR, "translation_key": "total_renew_power", "name": "Total Renewable Power", "device_class": SensorDeviceClass.POWER, "unit": UnitOfPower.WATT, "state_class": SensorStateClass.MEASUREMENT},
            ...
            C3Attributes.temp_ta_room: {"type": Platform.SENSOR, "translation_key": "temp_ta", "name": "TA - Room Temperature", "device_class": SensorDeviceClass.TEMPERATURE, "unit": UnitOfTemperature.CELSIUS, "state_class": SensorStateClass.MEASUREMENT},
            ...
            C3Attributes.total_electricity0: {"type": Platform.SENSOR, "translation_key": "total_electricity0", "name": "Total Electricity", "device_class": SensorDeviceClass.ENERGY, "unit": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            C3Attributes.total_thermal0: {"type": Platform.SENSOR, "translation_key": "total_thermal0", "name": "Total Thermal Energy", "device_class": SensorDeviceClass.ENERGY, "unit": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            C3Attributes.total_renew_power0: {"type": Platform.SENSOR, "translation_key": "total_renew_power", "name": "Total Renewable Energy", "device_class": SensorDeviceClass.ENERGY, "unit": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            C3Attributes.sys_heat_ins_hp_capacity: {"type": Platform.SENSOR, "translation_key": "sys_heat_ins_hp_capacity", "name": "Heat Instant HP Capacity", "device_class": SensorDeviceClass.POWER, "unit": UnitOfPower.WATT, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.sys_heat_ins_renew_power: {"type": Platform.SENSOR, "translation_key": "sys_heat_ins_renew_power", "name": "Heat Instant Renewable Power", "device_class": SensorDeviceClass.POWER, "unit": UnitOfPower.WATT, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.sys_heat_ins_power: {"type": Platform.SENSOR, "translation_key": "sys_heat_ins_power", "name": "Heat Instant Power", "device_class": SensorDeviceClass.POWER, "unit": UnitOfPower.WATT, "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.sys_heat_ins_copeer: {"type": Platform.SENSOR, "translation_key": "sys_heat_ins_copeer", "name": "Heat Instant COP/EER", "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.sys_heat_capacity: {"type": Platform.SENSOR, "translation_key": "sys_heat_capacity", "name": "Heat Capacity Total", "device_class": SensorDeviceClass.ENERGY, "unit": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            C3Attributes.sys_heat_renew_power: {"type": Platform.SENSOR, "translation_key": "sys_heat_renew_power", "name": "Heat Renewable Energy Total", "device_class": SensorDeviceClass.ENERGY, "unit": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            C3Attributes.sys_heat_elec_consum: {"type": Platform.SENSOR, "translation_key": "sys_heat_elec_consum", "name": "Heat Electricity Consumption Total", "device_class": SensorDeviceClass.ENERGY, "unit": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            C3Attributes.sys_heat_copeer: {"type": Platform.SENSOR, "translation_key": "sys_heat_copeer", "name": "Heat COP/EER", "state_class": SensorStateClass.MEASUREMENT},
            C3Attributes.comp_run_total_time0: {"type": Platform.SENSOR, "translation_key": "comp_run_total_time0", "name": "Compressor Total Runtime", "device_class": SensorDeviceClass.DURATION, "unit": UnitOfTime.HOURS, "state_class": SensorStateClass.TOTAL_INCREASING},
            C3Attributes.ibh1_run_total_time0: {"type": Platform.SENSOR, "translation_key": "ibh1_run_total_time0", "name": "IBH1 Total Runtime", "device_class": SensorDeviceClass.DURATION, "unit": UnitOfTime.HOURS, "state_class": SensorStateClass.TOTAL_INCREASING},
            C3Attributes.ibh2_run_total_time0: {"type": Platform.SENSOR, "translation_key": "ibh2_run_total_time0", "name": "IBH2 Total Runtime", "device_class": SensorDeviceClass.DURATION, "unit": UnitOfTime.HOURS, "state_class": SensorStateClass.TOTAL_INCREASING},
            C3Attributes.tbh_run_total_time0: {"type": Platform.SENSOR, "translation_key": "tbh_run_total_time0", "name": "TBH Total Runtime", "device_class": SensorDeviceClass.DURATION, "unit": UnitOfTime.HOURS, "state_class": SensorStateClass.TOTAL_INCREASING},
            C3Attributes.idu_t1s1: {"type": Platform.SENSOR, "translation_key": "idu_t1s1", "name": "Curve Target Temperature", "device_class": SensorDeviceClass.TEMPERATURE, "unit": UnitOfTemperature.CELSIUS, "state_class": SensorStateClass.MEASUREMENT},
